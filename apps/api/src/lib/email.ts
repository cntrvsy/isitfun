...
export async function sendEmail(options: SendEmailOptions) {
	...
	const from = options.from || 'IsItFun <noreply@frstudios.co.ke>';
...
export async function sendVerificationEmail({
	...
	const contentHtml = `
		...
		<p style="font-size: 12px; color: #64748b;">Or copy & paste this link: <br><span style="color: #818cf8;">${url}</span></p>
	`;
...
export async function sendPasswordResetEmail({
	...
	const contentHtml = `
		...
		<p>This password reset link will expire shortly. If you did not request this, please ignore this email.</p>
