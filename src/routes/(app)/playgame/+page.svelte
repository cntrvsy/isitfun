...
>
	...
	<div class="relative z-10 w-full max-w-md">
			...
			>
				...
				<div class="form-control">
					<label class="label mb-2" for="playtest-password">
						<span class="label-text block text-xs font-bold tracking-wider text-slate-300 uppercase"
		...
		<div class="mt-8 text-center">
			<a href={resolve('/')} class="text-xs text-slate-500 transition-colors hover:text-slate-300">
