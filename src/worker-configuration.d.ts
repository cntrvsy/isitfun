/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 5c4849c692ada45660d0ebbb0cb8e0a9)
...
interface __BaseEnv_Env {
	...
	CREEM_PRODUCT_ID_TEAM_PLAN: string;
	CREEM_TEST_MODE: string;
	CREEM_WEBHOOK_SECRET: string;
	TELEMETRY_BUFFER: DurableObjectNamespace /* TelemetrySessionDO */;
}
